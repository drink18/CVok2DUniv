...
TEST(cvVec3f, Init)
{
	...
	EXPECT_NEAR(v1.z, 1.5, CV_FLOAT_EPS);
}
...
TEST(cvVec3f, Proj)
{
...

    {
        ...
        EXPECT_NEAR(pv.z, 0.0f, CV_FLOAT_EPS);
    }
...
TEST(cvVec3f, Cross)
{
    ...
    EXPECT_NEAR(v.z, 1, CV_FLOAT_EPS);
}
